          ...
          <div className="bg-white rounded-3xl p-8 shadow-xl border border-slate-200">
            ...
            <div className="grid gap-6">
              ...
              <div className="relative flex items-center justify-center">
                ...
                <span className="absolute bg-white px-4 text-xs font-bold text-slate-400 uppercase">
                  Or Join Game
                </span>
              </div>
              ...
              <div className="flex gap-2">
                ...
                <button
                  ...
                  className="bg-slate-800 text-white px-8 rounded-2xl font-bold hover:bg-black transition-colors"
                >
                  Join
                </button>
              </div>
            ...
            <div className="bg-white rounded-3xl p-8 shadow-xl border border-slate-200">
              <div className="flex justify-between items-center mb-8 pb-6 border-b border-slate-100">
                <div>
                  ...
                  <button
                    onClick={copyRoomId}
                    className="font-mono text-sm text-indigo-600 hover:text-indigo-800 transition-colors"
                  >
              ...
              {!board ? (
                <div className="py-16 flex flex-col items-center justify-center border-4 border-dashed border-slate-100 rounded-3xl">
                  ...
                  <button
                    ...
                    className="bg-orange-500 hover:bg-orange-600 text-white px-10 py-4 rounded-2xl font-black text-lg shadow-lg transform transition active:scale-95"
                  >
                    SHAKE DICE
                  </button>
                </div>
        ...
        <div className="mt-12 px-4">
          ...
          <div className="space-y-2">
            {logs.map((log, i) => (
              <p
                key={i}
                className="text-[11px] font-medium text-slate-400 font-mono text-center"
              >
                {log}
              </p>
            ))}
